...
public class StartSitUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ScrollView situpResultScrollview = findViewById(R.id.situpResultScrollview);
        situpResultScrollview.setBackgroundColor(colorBackground);
        mSitupResult.setTextColor(colorDarkBackground);
        mSitupResult.setBackgroundColor(colorBackground);
